...
Weather_Data_Missing_Values <- Weather_Data_Missing_Values %>%
  ...
  transform(resultspeed = convert_wind_speed(resultspeed, old_metric = "knots", new_metric = "kmph")) %>%
  transform(avgspeed = covert_wind_speed(avgspeed, old_metric = "knots", new_metric = "kmph"))
