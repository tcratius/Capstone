...
#~~~~~~~~~~
Weather_Data_knn <- kNN(Weather_Data_knn, k = 4, imp_var = FALSE)
...
# Use Junk  
#~~~~~~~~~~~
Weather_Data_knn$codesum <- gsub("TSRA", 2L, Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- gsub("FZFG", 2L, Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- gsub("VCTS", 1L, Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- gsub("FZRA", 2L, Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- gsub("BLSN", 2L, Weather_Data_knn$codesum) 
Weather_Data_knn$codesum <- gsub("MIFG", 1L, Weather_Data_knn$codesum) 
Weather_Data_knn$codesum <- gsub("BCFG", 1L, Weather_Data_knn$codesum) 
