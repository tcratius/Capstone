...
Weather_Data_Missing_Values$codesum <- as.factor(Weather_Data_Missing_Values$codesum)

#~~~~~~~~~~~~
# Output to file 
#~~~~~~~~~~~
Weather_Data_knn$codesum <- gsub(" ", "", Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- trim(Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- gsub("(TS)\\1+", "\\1", Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- sub("(TS$)", "", Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- gsub("(RA)\\1+", "\\1", Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- gsub("(SN)\\1+", "\\1", Weather_Data_knn$codesum)
Weather_Data_knn$codesum <- gsub("(FG*)\\1+", "\\1", Weather_Data_knn$codesum)
#~~~~~~~~~~~
